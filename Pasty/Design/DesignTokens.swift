...
enum Pasty {
    ...
    enum Glass {
        ...
        static let innerGlow: CGFloat = 0.5
    }
    ...
    enum Motion {
        ...
        static let slowSpring = Animation.interactiveSpring(response: 0.5, dampingFraction: 0.78, blendDuration: 0.15)
    }
    ...
    enum Colors {
        ...
        static let queued = Color.yellow
    }
}
